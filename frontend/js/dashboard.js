...
// 🟣 Charts direct bovenaan gedeclareerd om fout te voorkomen
let maandChart = null;
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  function updateCharts(aanvragen) {
    ...
    maandChart = new Chart(ctx1, {
      ...
      data: {
        labels: maandLabels,
        datasets: [{ label: "Aanvragen", data: maandCounts, backgroundColor: "#4F46E5", borderRadius: 6 }],
      },
      options: {
    ...
    statusChart = new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{ data: statusData, backgroundColor: ["#6366F1", "#22C55E", "#EF4444", "#F59E0B"], borderWidth: 1 }],
      },
      options: {
        animation: { duration: 800 },
